...
app = FastAPI(title="SOC-Based Log Analysis System", version="2.1.0")
...
async def get_log_sources():
    ...
    return [
        ...
        {"name": "Windows Agent (WinRM)", "status": "error", "ip": "192.168.1.50", "type": "Endpoint"},
        {"name": "Firewall Stream", "status": "idle", "ip": "192.168.1.1", "type": "Network"}
    ]
